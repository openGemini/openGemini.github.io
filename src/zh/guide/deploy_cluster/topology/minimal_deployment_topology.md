...
| 实例     | 个数 | 物理机配置                                | IP                                              | 配置                  |
| :------- | :--- | :---------------------------------------- |:------------------------------------------------| :-------------------- |
| ts-sql   | 3    | 16 VCore 32 GiB 100 GiB 用于存储          | 192.168.1.1 192.168.1.2 192.168.1.3 192.168.1.4 | 默认端口 全局目录配置 |
| ts-meta  | 3    | 4 VCore 8 GiB 100 GiB 用于存储            | 192.168.1.1 192.168.1.2 192.168.1.3             | 默认端口 全局目录配置 |
| ts-store | 3    | 16 VCore 32 GiB 2 TiB (NVMe SSD) 用于存储 | 192.168.1.1 192.168.1.2 192.168.1.3 192.168.1.4 | 默认端口 全局目录配置 |
